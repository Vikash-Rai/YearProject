        ...
        <div className='mt-16 bg-cover bg-purple-700 flex flex-col items-center max-w-screen-lg overflow-hidden rounded-lg shadow-lg text-gray-600 w-full md:flex-row '>
            ...
            <div className='bg-white flex flex-col items-center p-4 space-y-8 w-full md:w-1/2'>
                <div className='flex flex-col items-center'>
                    <h1 className='font-medium text-purple-700 text-xl'>Welcome Patient</h1>
                    <p>Sign Up Patient!</p>
                </div>
                {/**Inputs */}
                <form className='flex flex-col items-center space-y-4'>
                    <div className='grid grid-cols-1 lg:grid-cols-2'>
                        <div className='relative'>
                            ...
                            <input className='border border-gray-300 outline-none placeholder-gray-400 pl-9 pr-4 py-1 rounded-md transition focus:ring-2 focus:ring-green-400' placeholder="username..." type="text" />
                        </div>
                        ...
                        <Link to = "/patOtp"> <button className='mt-7 bg-violet-700 font-medium inline-flex items-center px-3 py-1 rounded-md shadow-md text-white transition hover:bg-violet-500' type="submit">
                          Send OTP
        </button></Link>
                        </div>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <Link to = "/patientLogin"> <a className='ml-1 text-green-400 hover:underline'>Login Now</a></Link>
