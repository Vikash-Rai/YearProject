   ...
   <div className='bg-gradient-to-r from-purple-200 via-violet-300 to-violet-400 block items-center justify-center p-4 md:flex'>
       <div className='mt-16 bg-cover bg-purple-700 flex flex-col items-center max-w-screen-lg overflow-hidden rounded-lg shadow-lg text-gray-600 w-full md:flex-row '>
            ...
            Enter OTP
                ...
                <Link to = "/"><button className='mt-7 bg-violet-700 font-medium inline-flex items-center px-3 py-1 rounded-md shadow-md text-white transition hover:bg-violet-500' type="submit">
                    Submit
                </button></Link>
            ...
            <div className='flex flex-col items-center'>
                ...
                <Link to = "/patSignup"> <a className='ml-1 text-violet-700 hover:underline'>Back to Sign Up</a></Link>
